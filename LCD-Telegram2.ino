...
//Datos de WiFi
const char* ssid = "Redmi Note 8";  // Aquí debes poner el nombre de tu red
...
//const char* ssid = "Industria-4.0";  // Aquí debes poner el nombre de tu red
//const char* password = "INDUSTRIA40";  // Aquí debes poner la contraseña de tu red
//Datos del broker MQTT
const char* mqtt_server = "192.168.43.41"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
IPAddress server(192,168,43,41);
